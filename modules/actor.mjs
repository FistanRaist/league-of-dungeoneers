export class LODActor extends Actor {
  async _preCreate(data, options, user) {
    ...
    console.log("LODActor _preCreate called, initial data:", JSON.stringify(data, null, 2));
    ...
    console.log("LODActor _preCreate, final source:", JSON.stringify(this._source, null, 2));
  }
}